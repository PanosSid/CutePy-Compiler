...
public class TestSymbolTable {
	...
	public void testSymbolTableSymbol() throws CutePyException {
		setUpSyntaxAnalyser(""
				...
				+ "        #declare x\r\n"
				+ "        y = 1;\r\n"
				+ "        print(P1(x,y)); #$ kanonika itan void apla to evala prosorina #$\r\n"
				+ "    #}\r\n"
				+ "\r\n"
				+ "    #$ ma program #$\r\n"
				+ "    print(P1(a,b)); #$ kanonika itan void apla to evala prosorina #$\r\n"
				+ "    print(P2(c)); #$ kanonika itan void apla to evala prosorina #$\r\n"
				+ "\r\n"
				+ "#}\r\n"
				+ "\r\n"
				+ "if __name__ == \"__main__\":\r\n"
