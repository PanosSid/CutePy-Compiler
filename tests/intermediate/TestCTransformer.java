...
public class TestCTransformer {
	...
	public void testGetDeclerationOfVars() {
		...
		intermedCode.put(108, new Quad("begin_block, main, _, _\n"));
		intermedCode.put(109, new Quad("call, main_arithmetic, _, _\n"));
		intermedCode.put(110, new Quad("halt, _,_, _\n"));
		intermedCode.put(111, new Quad("end_block, main, _, _\n"));
	...
	public void testTransformIntermidateCodeToC() {
		...
		String expectedCcode = ""
				...
				+ "int main(){\n"
				+ "\tint x, y, T_1, T_2;\n"
				+ "\tL_100: 	// begin_block, main_arithmetic, _, _\n"
				+ "\tL_101: 	// par, x, cv, _\n"
				+ "\tL_102: 	// par, y, cv, _\n"
				+ "\tL_103: 	// par, T_1, ret, _\n"
				+ "\tL_104: 	// call, func, _, _\n"
				+ "\tL_105: T_2 = 1 + T_1;	// +, 1, T_1, T_2\n"
				+ "\tL_106: x = T_2;	// :=, T_2, _, x\n"
				+ "\tL_107: 	// end_block, main_arithmetic, _, _\n"
				+ "\tL_108: 	// begin_block, main, _, _\n"
				+ "\tL_109: 	// call, main_arithmetic, _, _\n"
				+ "\tL_110: return 0;	// halt, _, _, _\n"
				+ "\tL_111: 	// end_block, main, _, _\n"
				+ "}\n";
...
//	@Test 
	public void testTransformIntermidateCodeToC2() {
		...
		intermedCode.put(106, new Quad("begin_block, main, _, _\n"));
		intermedCode.put(107, new Quad("call, main_arithmetic, _, _\n"));
		intermedCode.put(108, new Quad("halt, _,_, _\n"));
		intermedCode.put(109, new Quad("end_block, main, _, _\n"));
	...
	public void testTransformIntermidateCodeToC3() {
		...
		String expectedCcode = ""
				...
				+ "int main(){\n"
				+ "	int a, b, T_1, t, c;\n"
				+ "	L_100: 	// begin_block, main_exams, _, _\n"
				+ "	L_101: a = 1;	// :=, 1, _, a\n"
				+ "	L_102: T_1 = a + b;	// +, a, b, T_1\n"
				+ "	L_103: if (T_1 < 1) goto L_105;	// <, T_1, 1, 105\n"
				+ "	L_104: goto L_127;	// jump, _, _, 127\n"
				+ "	L_105: if (b < 5) goto L_107;	// <, b, 5, 107\n"
				+ "	L_106: goto L_127;	// jump, _, _, 127\n"
				+ "	L_107: if (t == 1) goto L_109;	// ==, t, 1, 109\n"
				+ "	L_108: goto L_111;	// jump, _, _, 111\n"
				+ "	L_109: c = 2;	// :=, 2, _, c\n"
				+ "	L_110: goto L_116;	// jump, _, _, 116\n"
				+ "	L_111: if (t == 2) goto L_113;	// ==, t, 2, 113\n"
				+ "	L_112: goto L_115;	// jump, _, _, 115\n"
				+ "	L_113: c = 4;	// :=, 4, _, c\n"
				+ "	L_114: goto L_116;	// jump, _, _, 116\n"
				+ "	L_115: c = 0;	// :=, 0, _, c\n"
				+ "	L_116: if (a < 1) goto L_118;	// <, a, 1, 118\n"
				+ "	L_117: goto L_126;	// jump, _, _, 126\n"
				+ "	L_118: if (a == 2) goto L_120;	// ==, a, 2, 120\n"
				+ "	L_119: goto L_125;	// jump, _, _, 125\n"
				+ "	L_120: if (b == 1) goto L_122;	// ==, b, 1, 122\n"
				+ "	L_121: goto L_124;	// jump, _, _, 124\n"
				+ "	L_122: c = 2;	// :=, 2, _, c\n"
				+ "	L_123: goto L_120;	// jump, _, _, 120\n"
				+ "	L_124: goto L_125;	// jump, _, _, 125\n"
				+ "	L_125: goto L_116;	// jump, _, _, 116\n"
				+ "	L_126: goto L_102;	// jump, _, _, 102\n"
				+ "	L_127: 	// end_block, main_exams, _, _\n"
				+ "	L_128: 	// call, main_exams, _, _\n"
				+ "}\n"
				+ "";
		String actualCcode = transformer.getCcode();
		Assertions.assertEquals(expectedCcode, actualCcode);	
